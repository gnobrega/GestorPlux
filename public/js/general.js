...
function block(unblock) {
    if (!unblock) {
        $("#blockWaitDialog").modal();
    } else {
        $("#blockWaitDialog").modal('hide');
    }
}
...
/**
 * Mantem o conteudo sempre ajustado a tela
 */
function autoResize($parent, $target) {
    var parentWidth = parseInt($parent.css('width'));

    var objWidth = parseInt($target.css('width'));
    var objHeight = parseInt($target.css('height'));

    var cons = objWidth / objHeight;
    var newWidth = parentWidth;
    var newHeight = newWidth / cons;

    $target.css('width', newWidth + 'px !important');
    $target.css('height', newHeight + 'px !important');
}
